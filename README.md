...
- Get [Support](https://app-generator.dev/ticket/create/?generated_repo=https://github.com/app-generator/django-pixel-1751460160) via `eMail` and `Discord`
- Resources:
...
```bash
$ git clone https://github.com/django-pixel-1751460160.git
$ cd django-pixel-1751460160
```
